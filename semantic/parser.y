...
def:
  ...
  T_id params ':' type '=' expr { $$ = new Letdef($1, $2, $4, $6); }
  //| "mutable" T_id  { $$ = new Letdef(true, $2); }
  //| "mutable" commaExprs ']'  { $$ = new Letdef(true, $2); }
  | "mutable" T_id ':' type { $$ = new Letdef($2, $4); }
  | "mutable" commaExprs ']' ':' type { $$ = new Letdef($2, $5); }
;
...
exprs:
  ...
  | exprs expr_terminals   { $1->append($2); $$ = $1;}
;



commaExprs:
  T_id '[' expr_terminals           { $$ = new CommaExprList($1); $$->append($3); }
  | commaExprs ',' expr_terminals   { $1->append($3); $$ = $1; }
;
...
expr:
  ...
  | T_id exprs {$$ = new Function_call($1, $2); }
  | T_Id exprs { $$ = new Constr_call($1, $2); }
